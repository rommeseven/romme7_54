...
return array(
    ...
    'seven' => array(
        ...
        array('key' => 'main', 'name' => 'Haupt Content', 'default' => 'Elsőesigns so, dass verschiedene Endgeräte ein entsprechendes Erlebnis bieten. <br /><br />', 'type' => "html", "description" => 'Section 2 Content', 'validation' => "", 'module' => "all"),
        array('key' => 'unter', 'name' => 'Nem Content', 'default' => 'Második dass verschiedene Endgeräte ein entsprechendes Erlebnis bieten. <br /><br />', 'type' => "html", "description" => 'Section 2 Content', 'validation' => "", 'module' => "all"),
    ),
