...
return array(
    ...
    'seven' => array(
    	array('key' => 'app_title', 'name' => 'Application name', 'default' => env("APP_CODE","SEVEN") . ' APP', 'type' => "text", "description" => 'The display name of the website.', 'validation' => "sometimes|max:255"),
